        ...
        <div className={tw(`grid lg:grid-cols-2 gap-12 items-center`)}>
          <div className={tw(`text-left`)}>
            ...
            <p className={tw(`text-lg lg:text-xl text-slate-400 max-w-xl mb-10 leading-relaxed`)}>
              Atiende a tus clientes 24/7, califica leads automáticamente y agenda test drives sin intervención humana. Que tus vendedores se enfoquen en <span className={tw(`text-white font-semibold`)}>calificar leads y cerrar test drives.</span>
            </p>
